...
public final class Const {
    ...
    public static String[] knownRootAppsPackages = null;

    public static String[] knownDangerousAppsPackages = null;

    public static String[] knownRootCloakingPackages = null;

    // These must end with a /
    public static String[] suPaths = null;


    public static String[] pathsThatShouldNotBeWritable = null;

    public static void Init() {

        knownRootAppsPackages = new String[] {
        ...
        knownDangerousAppsPackages = new String[] {
        ...
        knownRootCloakingPackages = new String[] {
        ...
        pathsThatShouldNotBeWritable = new String[] {
                "/system",
                "/system/bin",
                "/system/sbin",
                "/system/xbin",
